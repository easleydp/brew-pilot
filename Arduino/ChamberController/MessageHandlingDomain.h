#ifndef MESSAGE_HANDLING_DOMAIN_H
#define MESSAGE_HANDLING_DOMAIN_H
...
void handleStatus() {
  ...
  printComma();
  Serial.print(minFreeRamLocation);
  printComma();
  Serial.print(badSensorCount);
  printComma();
  Serial.print(logBufferCannibalised);
...
#endif  // MESSAGE_HANDLING_DOMAIN_H