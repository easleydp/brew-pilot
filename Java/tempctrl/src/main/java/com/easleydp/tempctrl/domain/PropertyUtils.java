...
/**
 * TODO: As per the 3 May 2026 code review: This class uses a static Environment
 * reference.
 * While acceptable for a small project, consider using standard Spring property
 * injection
 * (@Value or @ConfigurationProperties) to improve testability.
 */
public class PropertyUtils {
    // Not really the Spring way but we inject the Environment statically, to save
    // clients having to supply it.
    ...
    /*
     * Some blessed properties are made accessible by name. Part of the convenience
     * is we can encapsulate the default values.
     */
